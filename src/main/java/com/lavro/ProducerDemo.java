...
public class ProducerDemo {
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty(KafkaAvroSerializerConfig.SCHEMA_REGISTRY_URL_CONFIG, SCHEMA_REGISTRY_URL);
        ...
        for(int i=0; i<10; i++){
            QueryRecord queryRecord = QueryRecord.newBuilder()
                    ...
                    .setSecretName(faker.artist().name().toString())
                    .setQueryEngine(faker.name().username())
                    .build();
            // create a producer record
            ProducerRecord<String, QueryRecord> producerRecord = new ProducerRecord<>("first_topic", queryRecord);
